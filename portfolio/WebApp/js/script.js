window.addEventListener('DOMContentLoaded', function() {
    ...
    new MenuCard(
        ...
        "post",
        'Меню "Постное"',
        'Меню "Постное" - это тщательный подбор ингредиентов: полное отсутвие продуктов животного происхождения,' +
     ...
     new MenuCard(
        ...
        ' Красная рабы, морепродукты, фрукты - ресторанное меню без похода в ресторан!',
        21,
        ".menu .container"
    ).render();
